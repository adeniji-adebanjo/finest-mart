...
function connect(param) {
    ...
    globalThis.TURBOPACK_CHUNK_UPDATE_LISTENERS = {
        push: function(param) {
            var _param = _sliced_to_array(param, 2), chunkPath = _param[0], callback = _param[1];
    ...
    if (Array.isArray(queued)) {
        ...
        try {
            for(var _iterator = queued[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                var _step_value = _sliced_to_array(_step.value, 2), chunkPath = _step_value[0], callback = _step_value[1];
                subscribeToChunkUpdate(chunkPath, sendMessage, callback);
            }
        } catch (err) {
...
function subscribeToUpdates(sendMessage, resource) {
    sendJSON(sendMessage, _object_spread({
...
function mergeChunkListChunks(chunksA, chunksB) {
    ...
    try {
        for(var _iterator = Object.entries(chunksA)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            var _step_value = _sliced_to_array(_step.value, 2), chunkPath = _step_value[0], chunkUpdateA = _step_value[1];
    ...
    try {
        for(var _iterator1 = Object.entries(chunksB)[Symbol.iterator](), _step1; !(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done); _iteratorNormalCompletion1 = true){
            var _step_value1 = _sliced_to_array(_step1.value, 2), chunkPath1 = _step_value1[0], chunkUpdateB1 = _step_value1[1];
...
function mergeEcmascriptChunkEntries(entriesA, entriesB) {
    return _object_spread({}, entriesA, entriesB);
}
...
function mergeEcmascriptChunkUpdates(updateA, updateB) {
    ...
    if (updateA.type === 'partial' && updateB.type === 'partial') {
        ...
        var added1 = new Set(_to_consumable_array((_updateA_added = updateA.added) !== null && _updateA_added !== void 0 ? _updateA_added : []).concat(_to_consumable_array((_updateB_added = updateB.added) !== null && _updateB_added !== void 0 ? _updateB_added : [])));
        var _updateA_deleted, _updateB_deleted;
        var deleted1 = new Set(_to_consumable_array((_updateA_deleted = updateA.deleted) !== null && _updateA_deleted !== void 0 ? _updateA_deleted : []).concat(_to_consumable_array((_updateB_deleted = updateB.deleted) !== null && _updateB_deleted !== void 0 ? _updateB_deleted : [])));
        ...
        return {
            type: 'partial',
            added: _to_consumable_array(added1),
            deleted: _to_consumable_array(deleted1)
        };
    }
    if (updateA.type === 'added' && updateB.type === 'partial') {
        var _updateA_modules1, _updateB_added1;
        var modules = new Set(_to_consumable_array((_updateA_modules1 = updateA.modules) !== null && _updateA_modules1 !== void 0 ? _updateA_modules1 : []).concat(_to_consumable_array((_updateB_added1 = updateB.added) !== null && _updateB_added1 !== void 0 ? _updateB_added1 : [])));
        ...
        return {
            type: 'added',
            modules: _to_consumable_array(modules)
        };
    }
    if (updateA.type === 'partial' && updateB.type === 'deleted') {
        ...
        return {
            type: 'deleted',
            modules: _to_consumable_array(modules1)
        };
    }
...
function emitIssues() {
    ...
    try {
        for(var _iterator = chunksWithIssues[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            var _step_value = _sliced_to_array(_step.value, 2), _ = _step_value[0], chunkIssues = _step_value[1];
            var _iteratorNormalCompletion1 = true, _didIteratorError1 = false, _iteratorError1 = undefined;
            try {
